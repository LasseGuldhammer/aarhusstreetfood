<div class="frame">
    <img id="openbutton" src="img/knaptilhjemmesideud.svg" alt="Aarhus Street Food logo">
</div>
...
<nav>
    ...
    <a href="index.php"> <img class="icon" src="img/logo.png" alt="Aarhus Street Food logo"> </a> 
